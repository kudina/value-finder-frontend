    ...
    <div className="flex flex-col md:flex-row bg-boxGrey w-full gap-[20px] pt-[30px] px-[30px] pb-[50px]">
      ...
      <div className="w-full md:w-[30%]">
        <div className="w-full h-fit bg-white shadow-shadow3 rounded-[5px]">
          ...
          <div className="w-full flex justify-center p-[20px]">
            <div className="relative">
              <img
                ...
                alt=""
                className="w-[13.56rem] h-[13.19rem]"
              />
              <div className="bg-green flex items-center justify-center h-[3.06rem] w-[7.5rem] rounded-[60px] text-white absolute left-[20%] bottom-[-10%] font-RubikRegular font-[500] leading-[30px]">
                <img
          ...
          <div className="mt-[30px] flex flex-col items-center">
            <p className="font-RubikRegular text-[1.56rem] text-[#4A4B4A] font-[500] leading-[30px]">
              Stimela Flickerz
            </p>
            <div className="flex items-center mt-[15px] text-[0.88rem] text-[#858585] leading-[17px]">
              <img
                src="/assets/images/location.png"
                alt=""
                className="w-[1.2rem] h-[1.5rem] mr-[22px]"
              />{" "}
          ...
          <div className="w-full flex border-t-[1px] border-t-[#CDCBCB] mt-[20px] pb-[10px]">
            <div className="w-[50%] flex flex-col items-center p-[30px] border-r-[1px] border-r-[#CDCBCB]">
              <p className="text-black text-[1.8rem] font-RubikRegular font-[500] leading-[36px]">
                27
              </p>
              <p className="text-[#858585] text-[1.13rem] font-RubikRegular font-[400] leading-[21px] mt-[10px]">
                cients
              </p>
            </div>
        ...
        <div className="mt-[50px] w-full h-fit bg-white shadow-shadow3 rounded-[5px] p-[20px]">
          ...
          <div className="mt-[20px]">
            <div className="flex w-full justify-between items-center border-t-[1px] border-t-[#DAD5D5] py-[20px]">
              ...
              />
              <span className="text-[1rem] font-[400] text-[#837E7E] leading-[19px] max-w-[16.31rem]">
                stimela@yaoo.com
              </span>{" "}
              <img
      ...
      <div className="w-full md:w-[40%]">
        ...
        <div className="w-full h-fit bg-white shadow-shadow3 rounded-[5px] px-[15px] py-[20px]">
          <div className="flex">
            <span className="max-w-[23.94rem] text-[1.13rem] text-black leading-[21px] font-[500]">
              UI/ UX Designer with over 10 years experience
            </span>
            <div className="flex items-center w-[5.4rem]">
              <img
                src="/assets/images/edit.png"
                alt=""
        ...
        {/* Work History */}
        <div className="w-full h-fit bg-white shadow-shadow3 rounded-[5px] pl-[15px] pr-[50px] pt-[20px] pb-[40px] mt-[30px]">
          <p className="text-[1.5rem] text-black font-[400] leading-[28px]">
            Work History
          </p>
          <div className="flex justify-between border-b-[1px] border-b-[#DAD5D5] mt-[25px]">
            <div className="w-[35%] border-b-[1px] border-b-green">
              Completed Jobs
            </div>
            <div className="w-[65%] ">Job in progress</div>
          </div>
          <div className="w-full px-[10px] pt-[10px] pb-[40px] rounded-[12px] bg-[#FAFAFA] shadow-shadow4 mt-[28px]">
            <div className="flex">
              <div className="mr-[67px]">
                <p className="text-[0.88rem] text-black font-[400] leading-[17px]">
                  Graphic Designer
                </p>
                <img src="/assets/images/starRating.png" alt="" />
              </div>
              <span className="text-[0.75rem] text-black font-[400] leading-[19px] self-end">
        ...
        <div className="w-full h-fit bg-white shadow-shadow3 rounded-[5px] pl-[15px] py-[20px] mt-[30px]">
          <div className="flex">
            <img
              ...
              alt=""
              className="h-[4.56rem] w-[4.56rem] mr-[20px]"
            />
            <div className="pt-[16px]">
              <p className="text-[1.25rem] text-black font-[500] leading-[19px]">
                Add qualifications
              </p>
        ...
        <div className="w-full h-fit bg-white shadow-shadow3 rounded-[5px] pl-[15px] py-[20px] mt-[30px]">
          <div className="flex">
            <img
              ...
              alt=""
              className="h-[3.75rem] w-[3.75rem] mr-[20px]"
            />
            <div className="pt-[16px]">
              <p className="text-[1.25rem] text-black font-[500] leading-[19px]">
                Add skills
      ...
      <div className="w-full md:w-[30%]">
        ...
        <div className="w-full h-fit bg-white shadow-shadow3 rounded-[5px] px-[10px] py-[20px]">
          <div className="text-[1.25rem] text-black font-[500] leading-[19px] mb-[31px] pb-[29px] px-[5px] border-b-[1px] border-b-[#D6D1D1]">
            27 clients
          </div>
          ...
          <Link className="w-full flex justify-center mt-[32px] text-[1.25rem] text-[#837E7E] font-[400] leading-[19px]">
            View All
          </Link>
        </div>
        {/* Portfolio */}
        <div className="w-full h-fit bg-white shadow-shadow3 mt-[30px] rounded-[5px] px-[10px] py-[20px]">
          ...
          <div className="w-full flex flex-wrap gap-x-[20px] gap-y-[10px] justify-center">
