      ...
      <div className="w-screen h-screen flex justify-between">
        <div className="flex flex-col w-[50%]">
          <div className="ml-[70px] mr-[70px]">
            <p className="font-GeorgiaSemiBold  text-LoginHeaderTextColor text-[35px] text-left mt-[70px]  leading-[50px]">
              Sign up to find work <br></br>or post work
            </p>
            ...
            <div>
                ...
                By clicking sign up you agree to valuefinder Terms of Service<br></br>
