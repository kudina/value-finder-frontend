...
const Description = () => {
  return (
    <div className="w-full h-fit bg-white mt-[10rem] flex px-[100px] gap-[20px] text-black">
      <div className="max-w-[900px] h-[791px] bg-grey rounded-tl-[57px] rounded-br-[57px] py-[30px] px-[20px]">
      ...
      <img src="/assets/images/hero3.svg" alt="" className="max-w-[599px]" />
    </div>
  );
};
