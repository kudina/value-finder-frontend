...
const BannerLand = () => {
  return (
    <div className="h-fit w-full bg-green">
      <HeaderLand />
      <div className="flex justify-between px-[88px] mt-[20px] text-white">
        <img
        ...
        <div className="w-[60%] mt-[82px]">
          <p className="font-GeorgiaSemiBold text-[60px] leading-[68px] max-w-[727px]">
            Find the best freelance services to meet your needs
          </p>
          <p className="mt-[20px] text-[20px] leading-[29px] font-RubikRegular font-[500] max-w-[593px]">
            Do you desire to get value for money engaging an Artisan...or offer
            value for money as an Artisan?
          </p>
          <div className="flex bg-white mt-[20px] items-center pl-[12px] rounded-[5px] h-[55px]">
