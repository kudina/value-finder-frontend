...
const FindSkill = () => {
  return (
    <div className="w-full h-[713px] bg-hero2 text-white relative">
      <p className="pt-[20px] pl-[15px] font-RubikRegular font-[500] text-[20px] leading-[24px]">
        FOR CLIENTS
      </p>
      <p className="mt-[40px] ml-[15px] font-GeorgiaRegular font-[400] text-[60px] leading-[68px] max-w-[509px]">
        Find your desired skill, just few clicks away
      </p>
      <p className="mt-[20px] ml-[15px] font-RubikRegular font-[400] text-[18px] leading-[21px] max-w-[381px]">
        Work with the largest network of independent professionals and get
        things done from quick turnaround to big transformation
      </p>

      <div className="absolute flex justify-between gap-[40px] h-[10rem] bottom-[-30.5px]  w-full px-[20px] ">
